...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=eshaanagg.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x67, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xa5, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x65, 0x73, 0x68, 0x61, 0x61, 0x6e, 0x61, 0x67, 0x67,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x65, 0x73, 0x68, 0x61, 0x61, 0x6e, 0x61, 0x67, 0x67,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: eshaanagg.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: eshaanagg.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: eshaanagg.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: eshaanagg.pcbook.Screen.resolution:type_name -> eshaanagg.pcbook.Screen.Resolution
	0, // 1: eshaanagg.pcbook.Screen.panel:type_name -> eshaanagg.pcbook.Screen.Panel
